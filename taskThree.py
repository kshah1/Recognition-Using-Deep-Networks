# Karan Shah
# Perform transfer learning on greek letters
...
def main(argv):
    ...
    # Change the final layer to 3 outputs
    transferModel.cvstack[10] = nn.Linear(50, 3)
    # Print the model
    # print(transferModel)
    # print()
    # Load the greek train data
    greekTrainData = loadData("GreekLetters/greek_train", 5)
    greekTestData = loadData("GreekLetters/greek_test", 1)
